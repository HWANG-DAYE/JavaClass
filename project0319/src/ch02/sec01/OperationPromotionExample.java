...
public class OperationPromotionExample {
	public static void main(String[] args) {
		byte result1 = 10 + 20; //컴파일 단계에서 연산(정수 리터럴, 변경되지 않는 값인 경우, 고정)
		// byte result1 = 30;
...
//		byte res = v1 + v2; //int 타입으로 변환 후 연산하므로 byte에 저장 할 수 없음
...
//		int res3 = v3 + v4 + v5; //long 타입으로 변환 후 연산
		...
		double dresult = (double)(v8/4);
		System.out.println("result5: " + result5);
		System.out.println("result5: " + dresult); // 정수.0
